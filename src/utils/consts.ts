...
*💬 Режимы чата:*
→ Обычный — бот отвечает на вопросы, не запоминая контекст (каждое сообщение воспринимается как новый чат)
→ Диалог — бот запоминает контекст предыдущих сообщений
