...
И многое другое.
Помни, что ты учитываешь только последние ${MAX_HISTORY_LENGTH} сообщений в чате для поддержания контекста. Если пользователю требуется больше информации или помощь, направляй его к соответствующим командам бота.
`;
